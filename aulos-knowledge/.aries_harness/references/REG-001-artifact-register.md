...
| ADR-006 | adr | decisions/adrs/ADR-006-allowlisted-sources-provenance.md | accepted |
| STORY-PACK-007 | story-pack | references/stories/STORY-PACK-007-music-knowledge-plane.md | complete |
| CKPT-007 | checkpoint | checkpoints/CKPT-007-music-knowledge-longrun.md | complete |
| VR-007 | verification-report | runs/reports/VR-007-music-knowledge-longrun.md | complete |
| SUM-007 | summarize-record | runs/reports/SUM-007-music-knowledge-longrun.md | complete |
| STATE | state | STATE.md | active |
| TASK_STACK | task-stack | TASK_STACK.md | active |
| JOURNAL | journal | JOURNAL.md | active |
| WORKER-DOC | runbook | docs/worker.md | active |
