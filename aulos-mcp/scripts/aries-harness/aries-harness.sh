...
Usage:
  ...
  bash scripts/aries-harness/aries-harness.sh well-organized [options]
  bash scripts/aries-harness/aries-harness.sh pipeline-inspect [options]
  bash scripts/aries-harness/aries-harness.sh memory-inspect [options]
  bash scripts/aries-harness/aries-harness.sh history-refresh [options]
  bash scripts/aries-harness/aries-harness.sh history-status [options]
  bash scripts/aries-harness/ah.sh <same-subcommand> [options]
