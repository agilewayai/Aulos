...
echo "  bash .aries_harness/scripts/aries-harness.sh init --project-root $project_root"
echo "  bash .aries_harness/scripts/aries-harness.sh well-organized --project-root $project_root"
echo "  bash .aries_harness/scripts/aries-harness.sh pipeline-inspect --project-root $project_root"
echo "  bash .aries_harness/scripts/aries-harness.sh memory-inspect --project-root $project_root"
echo "  bash .aries_harness/scripts/aries-harness.sh history-refresh --project-root $project_root"
echo "  bash .aries_harness/scripts/aries-harness.sh history-status --project-root $project_root"
